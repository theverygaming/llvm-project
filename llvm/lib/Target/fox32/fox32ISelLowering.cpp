...
#define DEBUG_TYPE "fox32-isel-lowering"

static cl::opt<bool> ZeroDivCheck("fox32-check-zero-division", cl::Hidden,
...
fox32TargetLowering::fox32TargetLowering(const TargetMachine &TM,
  ...
  addRegisterClass(GRLenVT, &fox32::GPRRegClass);
  ...
  setStackPointerRegisterToSaveRestore(fox32::X3);
...
SDValue fox32TargetLowering::lowerConstantPool(SDValue Op,
  ...
  if (!isPositionIndependent()) {
    ...
    SDValue AddrHi(DAG.getMachineNode(fox32::ADD, DL, Ty, ConstantN), 0);
    SDValue Addr(DAG.getMachineNode(fox32::ADD, DL, Ty, AddrHi, ConstantN), 0);
    return Addr;
  }
...
static fox32ISD::NodeType getfox32WOpcode(unsigned Opcode) {
  ...
  case ISD::SHL:
    return fox32ISD::SLL_W;
  case ISD::SRA:
    return fox32ISD::SRA_W;
  case ISD::SRL:
    return fox32ISD::SRL_W;
  }
}
...
static SDValue performANDCombine(SDNode *N, SelectionDAG &DAG,
  ...
  msb = lsb + SMLen - 1;
  return DAG.getNode(fox32ISD::BSTRPICK, DL, ValTy, NewOperand,
...
static SDValue performSRLCombine(SDNode *N, SelectionDAG &DAG,
  ...
  if (MaskIdx <= Shamt && Shamt <= MaskIdx + MaskLen - 1)
    return DAG.getNode(fox32ISD::BSTRPICK, DL, ValTy,
...
Retry:
  ...
  if (N0.getOpcode() == ISD::AND &&
    ...
    return DAG.getNode(fox32ISD::BSTRINS, DL, ValTy, N0.getOperand(0),
  ...
  if (N0.getOpcode() == ISD::AND &&
    ...
    return DAG.getNode(
        fox32ISD::BSTRINS, DL, ValTy, N0.getOperand(0),
  ...
  if (N1.getOpcode() == ISD::SHL && N1.getOperand(0).getOpcode() == ISD::AND &&
    ...
    if (ShMask.isSubsetOf(DAG.computeKnownBits(N0).Zero)) {
      ...
      return DAG.getNode(fox32ISD::BSTRINS, DL, ValTy, N0,
                         N1.getOperand(0).getOperand(0),
...
static MachineBasicBlock *insertDivByZeroTrap(MachineInstr &MI,
  ...
  BuildMI(MBB, FallThrough, MI.getDebugLoc(), TII.get(fox32::ADD))
      .addReg(Divisor.getReg(), getKillRegState(Divisor.isKill()))
      .addImm(8);

  // See linux header file arch/fox32/include/uapi/asm/break.h for the
...
const MCPhysReg ArgGPRs[] = {fox32::X4, fox32::X5, fox32::X6,  fox32::X7,
                             fox32::X8, fox32::X9, fox32::X10, fox32::X11};
...
SDValue fox32TargetLowering::LowerFormalArguments(
  ...
  analyzeInputArgs(CCInfo, Ins, CC_fox32);
...
SDValue fox32TargetLowering::LowerCall(CallLoweringInfo &CLI,
  ...
  analyzeOutputArgs(ArgCCInfo, Outs, CC_fox32);
  ...
  analyzeInputArgs(RetCCInfo, Ins, CC_fox32);
...
fox32TargetLowering::LowerReturn(SDValue Chain, CallingConv::ID CallConv,
  ...
  analyzeOutputArgs(CCInfo, Outs, CC_fox32);
