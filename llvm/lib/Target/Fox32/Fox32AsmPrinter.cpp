//===-- Fox32AsmPrinter.cpp - Fox32 LLVM Assembly Printer -----------------===//
//
...
#include "MCTargetDesc/Fox32InstPrinter.h"
...
public:
  ...
  virtual StringRef getPassName() const override {
    return "fox32 Assembly Printer";
  }

  void emitInstruction(const MachineInstr *MI) override;

  // Auto-generated function in Fox32GenMCPseudoLowering.inc
...
#include "Fox32GenMCPseudoLowering.inc"
...
void Fox32AsmPrinter::LowerInstruction(const MachineInstr *MI,
                                       MCInst &OutMI) const {
...
MCOperand Fox32AsmPrinter::LowerOperand(const MachineOperand& MO) const {
  switch (MO.getType()) {
