...
class Fox32RegisterInfo : public Fox32GenRegisterInfo {
protected:
  const Fox32Subtarget &Subtarget;

public:
  Fox32RegisterInfo(const Fox32Subtarget &Subtarget);
...
#endif // end LLVM_LIB_TARGET_FOX32_FOX32REGISTERINFO_H
