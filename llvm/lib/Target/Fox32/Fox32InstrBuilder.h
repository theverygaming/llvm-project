//===-- Fox32InstrBuilder.h - Functions to build Fox32 insts -----*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
#ifndef LLVM_LIB_TARGET_FOX32_FOX32INSTRBUILDER_H
#define LLVM_LIB_TARGET_FOX32_FOX32INSTRBUILDER_H
...
#endif // LLVM_LIB_TARGET_FOX32_FOX32INSTRBUILDER_H
