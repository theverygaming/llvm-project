...
void
FunnyarchMCCodeEmitter::getMachineOpValue(const MCInst &MI, const MCOperand &MO, APInt &Value, 
                                      SmallVectorImpl<MCFixup> &Fixups,
                                      const MCSubtargetInfo &STI) const {
  Value = 0;
  /*
...
void FunnyarchMCCodeEmitter::getImmOpValue(const MCInst &MI, unsigned OpNo, APInt &Value,
                                           SmallVectorImpl<MCFixup> &Fixups,
                                           const MCSubtargetInfo &STI) const {
...
void FunnyarchMCCodeEmitter::encodeInstruction(const MCInst &MI, raw_ostream &OS,
                                           SmallVectorImpl<MCFixup> &Fixups,
                                           const MCSubtargetInfo &STI) const {
