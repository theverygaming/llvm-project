//===-- FunnyarchInstrBuilder.h - Functions to build Funnyarch insts -----*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
#ifndef LLVM_LIB_TARGET_FUNNYARCH_FUNNYARCHINSTRBUILDER_H
#define LLVM_LIB_TARGET_FUNNYARCH_FUNNYARCHINSTRBUILDER_H
...
} // end namespace Funnyarch
} // end namespace llvm

#endif // LLVM_LIB_TARGET_FUNNYARCH_FUNNYARCHINSTRBUILDER_H
